...
class Itenspedidopdv_model extends CI_Model
{
    ...
    //select NOMEPRODUTO,CODBARRA, sum(estoque) as estoque from teste where CODBARRA IS NOT null GROUP by CODBARRA


    //    select NOMEPRODUTO, sum(estoque) as estoque from teste where CODBARRA IS null GROUP by NOMEPRODUTO
